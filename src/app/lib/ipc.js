...
function initIpc () {
  ...
  const asyncGlobals = {
    ...
    aegisGatewayPauseSession: (sessionId) => aegisGateway.pauseSession(undefined, sessionId),
    aegisGatewayResumeSession: (sessionId) => aegisGateway.resumeSession(undefined, sessionId),
